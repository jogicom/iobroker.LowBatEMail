...
Wenn die Globale Debug-Routine von mir (Siehe [Debug Routine](https://wagotec.de/iobroker-leere-batterien-ueberwachen-und-den-status-per-email-versenden) ) nicht installiert wurde, kommt es zu Fehlermeldungen, weil die Funktion "myDebug" nicht vorhanden ist.
